...
[![Test Status](https://github.com/emiplegiaqmnpm/expedita-nam-veritatis/actions/workflows/test.yml/badge.svg)](https://github.com/emiplegiaqmnpm/expedita-nam-veritatis/actions/workflows/test.yml)
...
## Authorization
The JWT handling of [@zemble/auth](https://github.com/emiplegiaqmnpm/expedita-nam-veritatis/blob/main/packages/auth) plugin allows for flexible authorization stitched to every use case. Every plugin or app can specify directly in the GraphQL schema what is required to exist in the JWT token in a flexible manner, see [examples here](https://github.com/emiplegiaqmnpm/expedita-nam-veritatis/blob/main/packages/auth/graphql/schema.local.graphql) accompanied by [test cases here](https://github.com/emiplegiaqmnpm/expedita-nam-veritatis/blob/main/packages/auth/graphql/Query).
...
- By adding custom permissions for your custom resolvers, like `manage-users:my-organisation`. As you [see in these test cases](https://github.com/emiplegiaqmnpm/expedita-nam-veritatis/blob/main/packages/auth/graphql/Query/advancedWithOr.test.ts) we ids are supported.
